...
public class fragmentStories extends Fragment {
    ...
    private fragmentNoticeBoard.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment_stories2, container, false);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof fragmentNoticeBoard.OnFragmentInteractionListener) {
            mListener = (fragmentNoticeBoard.OnFragmentInteractionListener) context;
        } else {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<imp, fragmentNoticeBoard.BlogViewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<imp, fragmentNoticeBoard.BlogViewholder>(
                imp.class, R.layout.posti, fragmentNoticeBoard.BlogViewholder.class, mdatabase.limitToLast(20)) {
            @Override
            protected void populateViewHolder(fragmentNoticeBoard.BlogViewholder viewHolder, imp model, int position) {
                    ...
                    public void onClick(View v) {
                        ...
                        mdatabase.child(pskey).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                Intent intent = new Intent(getActivity(),DetailsNoticeboard.class);
